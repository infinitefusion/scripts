...
class PokeBattle_Move_094 < PokeBattle_Move
  def pbOnStartUse(user, targets)
    ...
    if r < 40; @presentDmg = 40 elsif r < 70; @presentDmg = 80 elsif r < 80; @presentDmg = 120 end
  end
...
class PokeBattle_Move_098 < PokeBattle_Move
  def pbBaseDamage(baseDmg, user, target)
    ...
    if n < 2; ret = 200 elsif n < 5; ret = 150 elsif n < 10; ret = 100 elsif n < 17; ret = 80 elsif n < 33; ret = 40 end
    return ret
  end
end
...
class PokeBattle_Move_099 < PokeBattle_Move
  def pbBaseDamage(baseDmg, user, target)
    ...
    if n >= 4; ret = 150 elsif n >= 3; ret = 120 elsif n >= 2; ret = 80 elsif n >= 1; ret = 60 end
    return ret
  end
end
...
class PokeBattle_Move_09A < PokeBattle_Move
  def pbBaseDamage(baseDmg, user, target)
    ...
    if weight >= 2000; ret = 120 elsif weight >= 1000; ret = 100 elsif weight >= 500; ret = 80 elsif weight >= 250; ret = 60 elsif weight >= 100; ret = 40 end
    return ret
  end
end
...
class PokeBattle_Move_09B < PokeBattle_Move
  ...
  def pbBaseDamage(baseDmg, user, target)
    ...
    if n >= 5; ret = 120 elsif n >= 4; ret = 100 elsif n >= 3; ret = 80 elsif n >= 2; ret = 60 end
    return ret
  end
end
