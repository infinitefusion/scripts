...
module Settings
  ...
  POKERADAR_BATTERY_STEPS = HOENN ? 1000 : 0
  ...
  NB_POKEMON = 576# Settings::GAME_ID == :IF_HOENN ? 565 : 501
  ...
  LEVEL_CAPS_HOENN=[15, 19, 24, 99, 99, 99, 99, 99]
  ...
  PINKAN_ISLAND_MAPS= Settings::KANTO ? [51,46,428,531] : []
  ...
  REMOTE_NPC_DIALOG_SERVER_URL = "http://127.0.0.1:5050"
  #Technical
