...
E4_POKEMON_POOL = {
  :ELITEFOUR_Lorelei => [
    ...
    {:species => [:MILOTIC,:SCIZOR],   :level => 5, :item => :SITRUSBERRY, :ability => :TECHNICIAN,  :nature => :MODEST, :moves => [:QUIVERDANCE,:FROSTBREATH,:HIDDENPOWER,:OMINOUSWIND],    :tier => 4},
  ...
  :ELITEFOUR_Bruno => [
    ...
    {:species => [:LUCARIO,:WHIMSICOTT],   :level => 3, :item => :BLACKSLUDGE, :ability => :PRANKSTER,  :nature => :MODEST, :moves => [:COPYCAT,:MOONBLAST,:FOCUSBLAST,:LEECHSEED],    :tier => 3},
    {:species => [:HAWLUCHA,:ZOROARK],   :level => 4, :item => :FOCUSSASH, :ability => :ILLUSION,  :nature => :TIMID, :moves => [:DARKPULSE,:FOCUSBLAST,:NASTYPLOT,:FLAMETHROWER],    :tier => 3},
    ...
    {:species => [:BANETTE,:HERACROSS],   :level => 4, :item => :CHOICESCARF, :ability => :MOXIE,  :nature => :ADAMANT, :moves => [:SPECTRALTHIEF,:CLOSECOMBAT,:KNOCKOFF,:EARTHQUAKE],    :tier => 4},
    ...
    {:species => [:SALAMENCE,:GALLADE],   :level => 4, :item => :SITRUSBERRY, :ability => :INTIMIDATE,  :nature => :ADAMANT, :moves => [:DRAGONDANCE,:DRAINPUNCH,:DRAGONCLAW,:POISONJAB],    :tier => 4},
  ...
  :ELITEFOUR_Agatha => [
    ...
    {:species => [:LANTURN,:SHEDINJA],    :level => 5, :ability => :WONDERGUARD,   :moves => [:VOLTSWITCH,:SPIRITSHACKLE,:SCALD,:THUNDERWAVE],   :item => :SAFETYGOGGLES, :nature => :RASH, :tier => 3},
  ...
  :ELITEFOUR_Lance => [
    ...
    {:species => [:PORYGONZ,:NOIVERN],  :level => 5, :ability => :ADAPTABILITY,     :moves => [:BOOMBURST,:DRAGONCLAW,:TRIATTACK,:WHIRLWIND],     :item => :ASSAULTVEST, :tier => 4},


    {:species => [:URSARING,:DRAGONITE],  :level => 6, :ability => :GUTS,     :moves => [:SWORDSDANCE,:FIREPUNCH,:EXTREMESPEED,:FACADE],     :item => :FLAMEORB, :tier => 5},
