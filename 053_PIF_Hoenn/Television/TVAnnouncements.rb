...
def showTVannouncement
  if $PokemonGlobal.tv_announcements.length >= 1
    announcement_id = $PokemonGlobal.tv_announcements.first
    raw_message = TV_SPECIAL_ANNOUNCEMENTS[announcement_id]
    if raw_message
