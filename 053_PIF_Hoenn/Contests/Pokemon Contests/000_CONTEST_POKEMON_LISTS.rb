module GameData
  ...
  MASTER_RANK_CONTEST_POKEMON = {
    ...
    "Cute" => [:ALTARIA, :BELLOSSOM, :TOGEPI, :SHARPEDO, :PICHU, :XATU, :SLAKING, :LUVDISC, :MEOWTH, :SABLEYE, :DELCATTY, :SLOWKING, :PORYGON, :DELCATTY, :SLAKING, :LUVDISC, :PICHU, :MACHOKE, :ILLUMISE],
    "Tough" => [:ALTARIA, :SHARPEDO, :HERACROSS, :WOBBUFFET, :GYARADOS, :XATU, :SLAKING, :LUVDISC, :URSARING, :DRAGONITE, :SLOWKING, :GYARADOS, :SLAKING, :HERACROSS, :SHARPEDO, :DUSCLOPS],
    "Smart" => [:ALTARIA, :BELLOSSOM, :XATU, :WOBBUFFET, :MEOWTH, :SABLEYE, :KIRLIA, :JYNX, :PORYGON, :KIRLIA, :DUSCLOPS, :ILLUMISE, :LUVDISC, :SHARPEDO],
    "Cool" => [:ALTARIA, :SHARPEDO, :HERACROSS, :WOBBUFFET, :ESPEON, :GYARADOS, :URSARING, :DRAGONITE, :ELECTRODE, :KIRLIA, :LOUDRED, :PORYGON, :GYARADOS, :LOUDRED, :ELECTRODE, :HERACROSS],
  }
end
