...
#todo: defend. Attacks if being attacked by another ow pokemon

POKEMON_BEHAVIOR_DATA =
  {
    :BULBASAUR => { behavior_noticed: nil, behavior_roaming: :random , behavior_pokemon: {:HERACROSS => :shy}},
    ...
    :SQUIRTLE => { behavior_noticed: :curious, behavior_roaming: :random , behavior_pokemon: {:SHARPEDO => :skittish}},
    ...
    :BUTTERFREE => { behavior_noticed: :skittish,  behavior_roaming: :random , behavior_pokemon: {:CUTIEFLY => :semi_aggressive, :HERACROSS => :curious}},
    :WEEDLE => { behavior_noticed: :shy, behavior_roaming: :random },
    :KAKUNA => { behavior_noticed: :still, behavior_roaming: :still },
    :BEEDRILL => { behavior_noticed: :aggressive,  behavior_roaming: :random , behavior_pokemon: {:TEDDIURSA => :aggressive}},
    :PIDGEY => { behavior_noticed: nil,  behavior_roaming: :random , behavior_pokemon: {:EKANS => :shy, :SNEASEL => :skittish, :PERSIAN => :skittish}},
    :PIDGEOTTO => { behavior_noticed: nil,  behavior_roaming: :random, behavior_pokemon: {:MAGIKARP => :aggressive, :EXEGGCUTE => :aggressive, :CATERPIE => :aggressive}},
    :PIDGEOT => { behavior_noticed: nil,  behavior_roaming: :random, behavior_pokemon: {:MAGIKARP => :aggressive}},
    :RATTATA => { behavior_noticed: :shy, behavior_roaming: :random , behavior_pokemon: {:GUMSHOOS => :shy, :MEOWTH => :skittish, :ALOLAN_MEOWTH => :skittish}},
    :RATICATE => { behavior_noticed: nil, behavior_roaming: :random , behavior_pokemon: {:GUMSHOOS => :shy}},
    :SPEAROW => { behavior_noticed: :aggressive,  behavior_roaming: :random, behavior_pokemon: {:SUNKERN => :aggressive, :EKANS => :defend, :PERSIAN => :defend}},
    :FEAROW => { behavior_noticed: :aggressive,  behavior_roaming: :random },
    :EKANS => { behavior_noticed: :shy, behavior_roaming: :random , behavior_pokemon: {:PIDGEY => :semi_aggressive, :SPEAROW => :semi_aggressive}},
    :ARBOK => { behavior_noticed: :aggressive, behavior_roaming: :random , behavior_pokemon: {:WOOPER => :aggressive}},
    ...
    :PARASECT => { behavior_noticed: :aggressive, behavior_roaming: :random , behavior_pokemon: {:SHIINOTIC => :aggressive}},
    :VENONAT => { behavior_noticed: :shy, behavior_roaming: :random , behavior_pokemon: {:CATERPIE => :semi_aggressive, :WEEDLE => :semi_aggressive}},
    :VENOMOTH => { behavior_noticed: :shy,  behavior_roaming: :random },
    :DIGLETT => { behavior_noticed: :still, behavior_roaming: :random_burrow , behavior_pokemon: {:DRUDDIGON => :shy}},
    :DUGTRIO => { behavior_noticed: :still, behavior_roaming: :random_burrow , behavior_pokemon: {:DRUDDIGON => :shy}},
    :MEOWTH => { behavior_noticed: :curious, behavior_roaming: :random , behavior_pokemon: {:RATTATA => :semi_aggressive, :ALOLAN_RATTATA => :semi_aggressive, :MAGIKARP => :semi_aggressive, :MURKROW => :semi_aggressive}},
    :PERSIAN => { behavior_noticed: :aggressive, behavior_roaming: :random , behavior_pokemon: {:STARLY => :semi_aggressive, :PIDGEY => :semi_aggressive, :SPEAROW => :semi_aggressive}},
    ...
    :PRIMEAPE => { behavior_noticed: :aggressive, behavior_roaming: :random , behavior_pokemon: {:URSARING => :aggressive, :HAWLUCHA => :aggressive}},
    :GROWLITHE => { behavior_noticed: :curious, behavior_roaming: :random , behavior_pokemon: {:ROCKRUFF => :semi_aggressive}},
    ...
    :MACHOP => { behavior_noticed: nil, behavior_roaming: :random , behavior_pokemon: {:MAKUHITA => :semi_aggressive}},
    ...
    :TENTACOOL => { behavior_noticed: nil,  behavior_roaming: :random, glow_in_the_dark: true },
    :TENTACRUEL => { behavior_noticed: :aggressive,  behavior_roaming: :random, glow_in_the_dark: true },
    :GEODUDE => { behavior_noticed: :still, behavior_roaming: :random, hop_cliff:true},
    :GRAVELER => { behavior_noticed: :aggressive, behavior_roaming: :random, hop_cliff:true },
    ...
    :DEWGONG => { behavior_noticed: nil,  behavior_roaming: :random_dive , behavior_pokemon: {:WISHIWASHI => :aggressive}},
    :GRIMER => { behavior_noticed: :curious, behavior_roaming: :random , behavior_pokemon: {:TRUBBISH => :aggressive, :GARBODOR => :aggressive}},
    :MUK => { behavior_noticed: :aggressive, behavior_roaming: :random , behavior_pokemon: {:TRUBBISH => :aggressive, :GARBODOR => :aggressive}},
    :SHELLDER => { behavior_noticed: :skittish, behavior_roaming: :look_around, behavior_pokemon: {:KINGLER => :skittish, :OMASTAR => :skittish, :RUFFLET => :skittish, :BRUXISH => :skittish, :SLOWPOKE => :curious, :SLOWBRO => :curious}},
    :CLOYSTER => { behavior_noticed: nil, behavior_roaming: :random , behavior_pokemon: {:KINGLER => :shy, :SLOWPOKE => :semi_aggressive}},
    ...
    :DROWZEE => { behavior_noticed: :curious, behavior_roaming: :random , behavior_pokemon: {:KOMALA => :curious}},
    :HYPNO => { behavior_noticed: :aggressive, behavior_roaming: :random , behavior_pokemon: {:KOMALA => :curious}},
    :KRABBY => { behavior_noticed: :skittish, behavior_roaming: :random },
    :KINGLER => { behavior_noticed: :aggressive, behavior_roaming: :random, behavior_pokemon: {:SHELLDER => :aggressive, :CLOYSTER => :aggressive}},
    :VOLTORB => { behavior_noticed: :explode, behavior_roaming: :look_around },
    :ELECTRODE => { behavior_noticed: :explode, behavior_roaming: :random },
    :EXEGGCUTE => { behavior_noticed: nil, behavior_roaming: :random , behavior_pokemon: {:PIDGEOTTO => :shy, :CRABRAWLER => :defend}},
    :EXEGGUTOR => { behavior_noticed: nil, behavior_roaming: :random },
    :CUBONE => { behavior_noticed: nil, behavior_roaming: :random , behavior_pokemon: {:VULLABY => :shy, :MANDIBUZZ => :skittish}},
    :MAROWAK => { behavior_noticed: :aggressive, behavior_roaming: :random , behavior_pokemon: {:MANDIBUZZ => :aggressive}},
    ...
    :WEEZING => { behavior_noticed: nil, behavior_roaming: :random },
    ...
    :HORSEA => { behavior_noticed: :shy, behavior_roaming: :random_dive , behavior_pokemon: {:CORSOLA => :curious}},
    :SEADRA => { behavior_noticed: :aggressive, behavior_roaming: :random_dive , behavior_pokemon: {:CORSOLA => :curious, :MAREANIE => :semi_aggressive, :TOXAPEX => :semi_aggressive}},
    :GOLDEEN => { behavior_noticed: nil, behavior_roaming: :random_dive },
    :SEAKING => { behavior_noticed: nil, behavior_roaming: :random_dive },
    :STARYU => { behavior_noticed: nil, behavior_roaming: :random, glow_in_the_dark: true , behavior_pokemon: {:LUMINEON => :shy, :LANTURN => :shy}},
    :STARMIE => { behavior_noticed: nil, behavior_roaming: :random, glow_in_the_dark: true , behavior_pokemon: {:LUMINEON => :skittish, :LANTURN => :skittish}},
    ...
    :PINSIR => { behavior_noticed: :aggressive, behavior_roaming: :random , behavior_pokemon: {:HERACROSS => :aggressive, :VIKAVOLT => :aggressive}},
    ...
    :OMANYTE => { behavior_noticed: :shy, behavior_roaming: :random , behavior_pokemon: {:CARRACOSTA => :shy, :ARCHEOPS => :skittish}},
    :OMASTAR => { behavior_noticed: :aggressive, behavior_roaming: :random , behavior_pokemon: {:SHELLDER => :semi_aggressive, :CARRACOSTA => :shy}},
    ...
    :DRAGONITE => { behavior_noticed: :aggressive,  behavior_roaming: :random , behavior_pokemon: {:KINGDRA => :aggressive}},
    ...
    :FURRET => { behavior_noticed: nil, behavior_roaming: :random , behavior_pokemon: {:RATTATA => :aggressive, :MIGHTYENA => :skittish}},
    ...
    :AIPOM => { behavior_noticed: :curious, behavior_roaming: :random , behavior_pokemon: {:BOUNSWEET => :semi_aggressive}},
    :SUNKERN => { behavior_noticed: nil, behavior_roaming: :random, behavior_sunny_roaming: :random_spin, behavior_pokemon: {:SPEAROW => :defend}},
    ...
    :WOOPER => { behavior_noticed: nil, behavior_roaming: :random , behavior_pokemon: {:ARBOK => :shy}},
    :QUAGSIRE => { behavior_noticed: nil, behavior_roaming: :random },
    :ESPEON => { behavior_noticed: nil, behavior_roaming: :random },
    :UMBREON => { behavior_noticed: nil, behavior_roaming: :random, glow_in_the_dark: true },
    :MURKROW => { behavior_noticed: :aggressive,  behavior_roaming: :random , behavior_pokemon: {:MEOWTH => :semi_aggressive, :ALOLAN_MEOWTH => :semi_aggressive}},
    ...
    :QWILFISH => { behavior_noticed: :aggressive, behavior_roaming: :random , behavior_pokemon: {:LUVDISC => :aggressive}},
    :SCIZOR => { behavior_noticed: :aggressive, behavior_roaming: :random },
    :SHUCKLE => { behavior_noticed: :still, behavior_roaming: :random },
    :HERACROSS => { behavior_noticed: :aggressive, behavior_roaming: :random , behavior_pokemon: {:PINSIR => :aggressive, :VIKAVOLT => :aggressive, :BULBASAUR => :curious, :BUTTERFREE => :curious}},
    :SNEASEL => { behavior_noticed: :skittish, behavior_roaming: :random , behavior_pokemon: {:PIDGEY => :aggressive, :ALOLAN_SANDSHREW => :semi_aggressive, :DELIBIRD => :aggressive}},
    :TEDDIURSA => { behavior_noticed: :curious, behavior_roaming: :random , behavior_pokemon: {:BEEDRILL => :defend, :COMBEE => :curious}},
    :URSARING => { behavior_noticed: :aggressive, behavior_roaming: :random , behavior_pokemon: {:PRIMEAPE => :aggressive}},
    :SLUGMA => { behavior_noticed: nil, behavior_roaming: :random, glow_in_the_dark: true},
    :MAGCARGO => { behavior_noticed: nil, behavior_roaming: :random, glow_in_the_dark: true },
    :SWINUB => { behavior_noticed: :shy, behavior_roaming: :random },
    :PILOSWINE => { behavior_noticed: nil, behavior_roaming: :random },
    :CORSOLA => { behavior_noticed: nil, behavior_roaming: :random , behavior_pokemon: {:MAREANIE => :skittish, :TOXAPEX => :skittish, :SEADRA => :curious}},
    :REMORAID => { behavior_noticed: nil, behavior_roaming: :random , behavior_pokemon: {:BURMY_P => :semi_aggressive, :BURMY_S => :semi_aggressive, :BURMY_T => :semi_aggressive, :MANTINE => :curious}},
    :OCTILLERY => { behavior_noticed: :semi_aggressive, behavior_roaming: :random },
    :DELIBIRD => { behavior_noticed: :curious,  behavior_roaming: :random , behavior_pokemon: {:SNEASEL => :shy}},
    ...
    :KINGDRA => { behavior_noticed: nil, behavior_roaming: :random , behavior_pokemon: {:DRAGONITE => :aggressive}},
    ...
    :ELEKID => { behavior_noticed: :curious, behavior_roaming: :random , behavior_pokemon: {:TOGEDEMARU => :semi_aggressive}},
    ...
    :TAILLOW => { behavior_noticed: :skittish,  behavior_roaming: :random , behavior_pokemon: {:WURMPLE => :aggressive}},
    :SWELLOW => { behavior_noticed: :skittish,  behavior_roaming: :random , behavior_pokemon: {:WURMPLE => :aggressive}},
    :WINGULL => { behavior_noticed: :flee_flying, behavior_roaming: :random , behavior_pokemon: {:FINNEON => :aggressive, :WISHIWASHI => :aggressive, :TALONFLAME => :skittish}},
    :PELIPPER => { behavior_noticed: nil,  behavior_roaming: :random , behavior_pokemon: {:LUVDISC => :aggressive, :WISHIWASHI => :aggressive}},
    ...
    :SURSKIT => { behavior_noticed: nil, behavior_roaming: :water_skip , behavior_pokemon: {:DEWPIDER => :semi_aggressive}},
    ...
    :EXPLOUD => { behavior_noticed: :aggressive, behavior_roaming: :random , behavior_pokemon: {:AXEW => :semi_aggressive}},
    :MAKUHITA => { behavior_noticed: :curious, behavior_roaming: :random , behavior_pokemon: {:MACHOP => :semi_aggressive}},
    ...
    :SABLEYE => { behavior_noticed: :curious, behavior_roaming: :random , behavior_pokemon: {:CARBINK => :semi_aggressive, :GABITE => :semi_aggressive}},
    ...
    :VOLBEAT => { behavior_noticed: nil,  behavior_roaming: :random, glow_in_the_dark: true },
    :ILLUMISE => { behavior_noticed: nil,  behavior_roaming: :random, glow_in_the_dark: true },
    ...
    :CARVANHA => { behavior_noticed: :aggressive, behavior_roaming: :random , behavior_pokemon: {:BASCULIN => :aggressive}},
    :SHARPEDO => { behavior_noticed: :aggressive, behavior_roaming: :random , behavior_pokemon: {:WAILMER => :aggressive, :SQUIRTLE => :aggressive, :LANTURN => :aggressive, :FINNEON => :aggressive, :LUMINEON => :aggressive}},
    :WAILMER => { behavior_noticed: :curious, behavior_roaming: :random , behavior_pokemon: {:WISHIWASHI => :semi_aggressive, :SHARPEDO => :skittish, :DHELMISE => :shy}},
    :WAILORD => { behavior_noticed: nil, behavior_roaming: :random , behavior_pokemon: {:WISHIWASHI_SCHOOL => :semi_aggressive, :DHELMISE => :defend}},
    ...
    :SPOINK => { behavior_noticed: :curious, behavior_roaming: :random , behavior_pokemon: {:CLAMPERL => :semi_aggressive}},
    :GRUMPIG => { behavior_noticed: nil, behavior_roaming: :random },
    :SPINDA => { behavior_noticed: :curious, behavior_roaming: :random_spin , behavior_pokemon: {:SALANDIT => :defend}},
    :TRAPINCH => { behavior_noticed: :still, behavior_roaming: :random , behavior_pokemon: {:SANDILE => :defend}},
    :VIBRAVA => { behavior_noticed: nil,  behavior_roaming: :random },
    :FLYGON => { behavior_noticed: nil,  behavior_roaming: :random , behavior_pokemon: {:KROOKODILE => :curious}},
    ...
    :SEVIPER => { behavior_noticed: :aggressive, behavior_roaming: :random, behavior_pokemon: {:ZANGOOSE => :aggressive}},
    ...
    :GLALIE => { behavior_noticed: :aggressive, behavior_roaming: :random , behavior_pokemon: {:VANILLITE => :aggressive}},
    ...
    :LUVDISC => { behavior_noticed: :curious, behavior_roaming: :random , behavior_pokemon: {:PELIPPER => :skittish, :QWILFISH => :skittish, :CORSOLA => :curious}},
    :BAGON => { behavior_noticed: :semi_aggressive, behavior_roaming: :random },
    :SHELGON => { behavior_noticed: :still, behavior_roaming: :random },
    :SALAMENCE => { behavior_noticed: :aggressive,  behavior_roaming: :random , behavior_pokemon: {:GARCHOMP => :aggressive}},
    :BELDUM => { behavior_noticed: :still,  behavior_roaming: :random },
    :METANG => { behavior_noticed: nil,  behavior_roaming: :random , behavior_pokemon: {:NOSEPASS => :excited}},
    ...
    :STARLY => { behavior_noticed: :skittish,  behavior_roaming: :random , behavior_pokemon: {:WURMPLE => :aggressive, :CHERUBI => :semi_aggressive, :WORMADAM_P => :semi_aggressive, :WORMADAM_S => :semi_aggressive, :WORMADAM_T => :semi_aggressive, :SCATTERBUG => :aggressive, :PERSIAN => :skittish, :GROTLE => :curious}},
    ...
    :WORMADAM_P => { behavior_noticed: :still, behavior_roaming: :still , behavior_pokemon: {:STARLY => :skittish}},
    :WORMADAM_S => { behavior_noticed: :still, behavior_roaming: :still },
    :WORMADAM_T => { behavior_noticed: :still, behavior_roaming: :still , behavior_pokemon: {:STARLY => :shy}},
    :MOTHIM => { behavior_noticed: :curious,  behavior_roaming: :random , behavior_pokemon: {:COMBEE => :curious}},
    ...
    :AMBIPOM => { behavior_noticed: :curious, behavior_roaming: :random , behavior_pokemon: {:PASSIMIAN => :semi_aggressive}},
    :DRIFLOON => { behavior_noticed: :curious,  behavior_roaming: :random, behavior_wind_roaming: :blown_away , behavior_pokemon: {:JOLTIK => :semi_aggressive}},
    :DRIFBLIM => { behavior_noticed: :curious,  behavior_roaming: :random , behavior_pokemon: {:CLAMPERL => :semi_aggressive}},
    ...
    :GABITE => { behavior_noticed: :aggressive, behavior_roaming: :random , behavior_pokemon: {:SABLEYE => :semi_aggressive}},
    :GARCHOMP => { behavior_noticed: :aggressive,  behavior_roaming: :random , behavior_pokemon: {:SALAMENCE => :aggressive}},
    ...
    :FINNEON => { behavior_noticed: :skittish, behavior_roaming: :random, glow_in_the_dark: true , behavior_pokemon: {:WINGULL => :shy, :SHARPEDO => :skittish}},
    :LUMINEON => { behavior_noticed: nil, behavior_roaming: :random, glow_in_the_dark: true , behavior_pokemon: {:STARYU => :semi_aggressive, :SHARPEDO => :skittish, :CLAMPERL => :semi_aggressive}},
    :SNOVER => { behavior_noticed: nil, behavior_roaming: :random , behavior_pokemon: {:STARMIE => :aggressive}},
    :ABOMASNOW => { behavior_noticed: :aggressive, behavior_roaming: :random },
    :WEAVILE => { behavior_noticed: :aggressive, behavior_roaming: :random , behavior_pokemon: {:ALOLAN_SANDSHREW => :aggressive, :ALOLAN_VULPIX => :aggressive, :MAMOSWINE => :aggressive}},
    ...
    :ROGGENROLA => { behavior_noticed: :still, behavior_roaming: :look_around , behavior_pokemon: {:DWEBBLE => :shy}},
    ...
    :BASCULIN => { behavior_noticed: :aggressive, behavior_roaming: :random , behavior_pokemon: {:CARVANHA => :aggressive}},
    :SANDILE => { behavior_noticed: :aggressive, behavior_roaming: :random , behavior_pokemon: {:TRAPINCH => :semi_aggressive}},
    :KROKOROK => { behavior_noticed: :aggressive, behavior_roaming: :random },
    :KROOKODILE => { behavior_noticed: :aggressive, behavior_roaming: :random , behavior_pokemon: {:FLYGON => :curious}},
    ...
    :DWEBBLE => { behavior_noticed: :skittish, behavior_roaming: :still , behavior_pokemon: {:ROGGENROLA => :semi_aggressive, :HIPPOWDON => :curious}},
    ...
    :CARRACOSTA => { behavior_noticed: :aggressive, behavior_roaming: :random , behavior_pokemon: {:OMANYTE => :semi_aggressive, :OMASTAR => :semi_aggressive}},
    :ARCHEN => { behavior_noticed: :skittish,  behavior_roaming: :random },
    :ARCHEOPS => { behavior_noticed: :aggressive,  behavior_roaming: :random , behavior_pokemon: {:OMANYTE => :aggressive}},
    :TRUBBISH => { behavior_noticed: :curious, behavior_roaming: :random , behavior_pokemon: {:ALOLAN_GRIMER => :skittish, :ALOLAN_MUK => :skittish, :GRIMER => :skittish, :MUK => :skittish}},
    :GARBODOR => { behavior_noticed: :aggressive, behavior_roaming: :random , behavior_pokemon: {:ALOLAN_GRIMER => :shy, :ALOLAN_MUK => :shy, :GRIMER => :shy, :MUK => :shy}},
    ...
    :VANILLITE => { behavior_noticed: nil, behavior_roaming: :random , behavior_pokemon: {:GLALIE => :skittish}},
    :VANILLISH => { behavior_noticed: nil, behavior_roaming: :random },
    :VANILLUXE => { behavior_noticed: nil, behavior_roaming: :random },
    :DEERLING_SPRING => { behavior_noticed: :skittish, behavior_roaming: :random , behavior_pokemon: {:LYCANROC_D => :skittish, :LYCANROC_DUSK => :skittish, :LYCANROC_N => :skittish}},
    :DEERLING_SUMMER => { behavior_noticed: :skittish, behavior_roaming: :random , behavior_pokemon: {:LYCANROC_D => :skittish, :LYCANROC_DUSK => :skittish, :LYCANROC_N => :skittish}},
    :DEERLING_AUTUMN => { behavior_noticed: :skittish, behavior_roaming: :random , behavior_pokemon: {:LYCANROC_D => :skittish, :LYCANROC_DUSK => :skittish, :LYCANROC_N => :skittish}},
    :DEERLING_WINTER => { behavior_noticed: :skittish, behavior_roaming: :random , behavior_pokemon: {:LYCANROC_D => :skittish, :LYCANROC_DUSK => :skittish, :LYCANROC_N => :skittish}},
    ...
    :KARRABLAST => { behavior_noticed: :aggressive, behavior_roaming: :random , behavior_pokemon: {:SHELMET => :semi_aggressive}},
    :ESCAVALIER => { behavior_noticed: nil, behavior_roaming: :random , behavior_pokemon: {:SHELMET => :semi_aggressive}},
    ...
    :JELLICENT => { behavior_noticed: :semi_aggressive,  behavior_roaming: :random },
    :JOLTIK => { behavior_noticed: nil, behavior_roaming: :random , behavior_pokemon: {:PIKACHU => :semi_aggressive, :STUNFISK => :semi_aggressive, :EMOLGA => :semi_aggressive}},
    ...
    :FRAXURE => { behavior_noticed: :aggressive, behavior_roaming: :random , behavior_pokemon: {:BISHARP => :aggressive}},
    :HAXORUS => { behavior_noticed: :aggressive, behavior_roaming: :random },
    :CUBCHOO => { behavior_noticed: :curious, behavior_roaming: :random },
    :BEARTIC => { behavior_noticed: :aggressive, behavior_roaming: :random , behavior_pokemon: {:MAGIKARP => :semi_aggressive}},
    :CRYOGONAL => { behavior_noticed: nil,  behavior_roaming: :random },
    :SHELMET => { behavior_noticed: nil, behavior_roaming: :random , behavior_pokemon: {:KARRABLAST => :defend, :ESCAVALIER => :defend}},
    ...
    :DRUDDIGON => { behavior_noticed: :aggressive, behavior_roaming: :random , behavior_pokemon: {:ALOLAN_DIGLETT => :semi_aggressive, :ALOLAN_DUGTRIO => :semi_aggressive, :DIGLETT => :semi_aggressive, :DUGTRIO => :semi_aggressive}},
    ...
    :BISHARP => { behavior_noticed: :aggressive, behavior_roaming: :random , behavior_pokemon: {:FRAXURE => :aggressive}},
    :BOUFFALANT => { behavior_noticed: :aggressive, behavior_roaming: :random },
    :RUFFLET => { behavior_noticed: :aggressive,  behavior_roaming: :random , behavior_pokemon: {:SHELLDER => :aggressive, :SPEWPA => :semi_aggressive}},
    :BRAVIARY => { behavior_noticed: :aggressive,  behavior_roaming: :random },
    :VULLABY => { behavior_noticed: :skittish,  behavior_roaming: :random },
    :MANDIBUZZ => { behavior_noticed: :aggressive,  behavior_roaming: :random , behavior_pokemon: {:CUBONE => :aggressive}},
    :HEATMOR => { behavior_noticed: nil, behavior_roaming: :random , behavior_pokemon: {:DURANT => :aggressive}},
    :DURANT => { behavior_noticed: :aggressive, behavior_roaming: :random , behavior_pokemon: {:HEATMOR => :defend}},
    ...
    :FLETCHINDER => { behavior_noticed: :aggressive,  behavior_roaming: :random , behavior_pokemon: {:PIKIPEK => :aggressive}},
    :TALONFLAME => { behavior_noticed: :aggressive,  behavior_roaming: :random , behavior_pokemon: {:WINGULL => :aggressive, :PIKIPEK => :aggressive}},
    :SCATTERBUG => { behavior_noticed: :shy, behavior_roaming: :random , behavior_pokemon: {:STARLY => :defend}},
    :SPEWPA => { behavior_noticed: :still, behavior_roaming: :still , behavior_pokemon: {:RUFFLET => :defend}},
    ...
    :FLABEBE => { behavior_noticed: :curious,  behavior_roaming: :random },
    :FLOETTE => { behavior_noticed: :curious,  behavior_roaming: :random },
    :FLORGES => { behavior_noticed: :curious,  behavior_roaming: :random },
    :SKIDDO => { behavior_noticed: :curious, behavior_roaming: :random, hop_cliff:true},
    :GOGOAT => { behavior_noticed: nil, behavior_roaming: :random, hop_cliff:true},
    ...
    :INKAY => { behavior_noticed: :curious,  behavior_roaming: :random , behavior_pokemon: {:CHINCHOU => :semi_aggressive}},
    ...
    :SKRELP => { behavior_noticed: nil, behavior_roaming: :random , behavior_pokemon: {:DHELMISE => :curious}},
    :DRAGALGE => { behavior_noticed: :aggressive, behavior_roaming: :random , behavior_pokemon: {:DHELMISE => :curious}},
    ...
    :HAWLUCHA => { behavior_noticed: nil,  behavior_roaming: :random , behavior_pokemon: {:PRIMEAPE => :aggressive}},
    :DEDENNE => { behavior_noticed: :skittish, behavior_roaming: :random },
    :CARBINK => { behavior_noticed: :still, behavior_roaming: :look_around , behavior_pokemon: {:SABLEYE => :shy}},
    ...
    :PIKIPEK => { behavior_noticed: :curious,  behavior_roaming: :random , behavior_pokemon: {:TALONFLAME => :skittish, :METAPOD => :aggressive, :FLETCHINDER => :shy, :BOUNSWEET => :aggressive}},
    :TRUMBEAK => { behavior_noticed: :curious,  behavior_roaming: :random },
    :TOUCANNON => { behavior_noticed: :aggressive,  behavior_roaming: :random , behavior_pokemon: {:BOUNSWEET => :aggressive}},
    :YUNGOOS => { behavior_noticed: :aggressive, behavior_roaming: :random },
    :GUMSHOOS => { behavior_noticed: :aggressive, behavior_roaming: :random , behavior_pokemon: {:RATTATA => :semi_aggressive, :RATICATE => :semi_aggressive, :ALOLAN_RATTATA => :semi_aggressive, :ALOLAN_RATICATE => :semi_aggressive}},
    :GRUBBIN => { behavior_noticed: :shy, behavior_roaming: :random },
    :CHARJABUG => { behavior_noticed: :still, behavior_roaming: :look_around },
    :VIKAVOLT => { behavior_noticed: :aggressive,  behavior_roaming: :random , behavior_pokemon: {:PINSIR => :aggressive, :HERACROSS => :aggressive}},
    :CRABRAWLER => { behavior_noticed: :aggressive, behavior_roaming: :random , behavior_pokemon: {:EXEGGCUTE => :semi_aggressive}},
    ...
    :CUTIEFLY => { behavior_noticed: :skittish,  behavior_roaming: :random , behavior_pokemon: {:SPINARAK => :shy, :PINECO => :shy, :BUTTERFREE => :semi_aggressive, :FOMANTIS => :curious}},
    :RIBOMBEE => { behavior_noticed: :skittish,  behavior_roaming: :random },
    :ROCKRUFF => { behavior_noticed: :curious, behavior_roaming: :random , behavior_pokemon: {:GROWLITHE => :semi_aggressive}},
    :LYCANROC_D => { behavior_noticed: nil, behavior_roaming: :random , behavior_pokemon: {:DEERLING_SPRING => :semi_aggressive, :DEERLING_SUMMER => :semi_aggressive, :DEERLING_AUTUMN => :semi_aggressive, :DEERLING_WINTER => :semi_aggressive}},
    :LYCANROC_DUSK => { behavior_noticed: :curious, behavior_roaming: :random , behavior_pokemon: {:DEERLING_SPRING => :semi_aggressive, :DEERLING_SUMMER => :semi_aggressive, :DEERLING_AUTUMN => :semi_aggressive, :DEERLING_WINTER => :semi_aggressive}},
    :LYCANROC_N => { behavior_noticed: :aggressive, behavior_roaming: :random , behavior_pokemon: {:DEERLING_SPRING => :aggressive, :DEERLING_SUMMER => :aggressive, :DEERLING_AUTUMN => :aggressive, :DEERLING_WINTER => :aggressive}},
    :WISHIWASHI => { behavior_noticed: :skittish, behavior_roaming: :random , behavior_pokemon: {:DEWGONG => :skittish, :WAILMER => :skittish, :WAILORD => :skittish, :WINGULL => :skittish, :PELIPPER => :skittish}},
    :WISHIWASHI_SCHOOL => { behavior_noticed: :aggressive, behavior_roaming: :random , behavior_pokemon: {:WAILORD => :skittish}},
    :MAREANIE => { behavior_noticed: :aggressive, behavior_roaming: :random , behavior_pokemon: {:CORSOLA => :aggressive, :BRUXISH => :defend, :CLAMPERL => :semi_aggressive}},
    :TOXAPEX => { behavior_noticed: :aggressive, behavior_roaming: :random , behavior_pokemon: {:CORSOLA => :semi_aggressive, :BRUXISH => :aggressive}},
    :MUDSDALE => { behavior_noticed: nil, behavior_roaming: :random },
    :DEWPIDER => { behavior_noticed: nil, behavior_roaming: :random , behavior_pokemon: {:SURSKIT => :semi_aggressive}},
    :ARAQUANID => { behavior_noticed: nil, behavior_roaming: :random },
    :FOMANTIS => { behavior_noticed: :shy, behavior_roaming: :random , behavior_pokemon: {:CUTIEFLY => :semi_aggressive}},
    :LURANTIS => { behavior_noticed: nil, behavior_roaming: :random , behavior_pokemon: {:KRICKETOT => :semi_aggressive}},
    :MORELULL => { behavior_noticed: :shy, behavior_roaming: :random, glow_in_the_dark: true },
    :SHIINOTIC => { behavior_noticed: nil, behavior_roaming: :random, glow_in_the_dark: true , behavior_pokemon: {:PARASECT => :aggressive}},
    :STUFFUL => { behavior_noticed: :curious, behavior_roaming: :random },
    :BEWEAR => { behavior_noticed: :excited, behavior_roaming: :random },
    :BOUNSWEET => { behavior_noticed: :skittish, behavior_roaming: :random , behavior_pokemon: {:AIPOM => :skittish, :BOUNSWEET => :skittish}},
    ...
    :PASSIMIAN => { behavior_noticed: :aggressive, behavior_roaming: :random , behavior_pokemon: {:AMBIPOM => :semi_aggressive}},
    ...
    :TOGEDEMARU => { behavior_noticed: :curious, behavior_roaming: :random , behavior_pokemon: {:ELEKID => :semi_aggressive}},
    :MIMIKYU => { behavior_noticed: :shy, behavior_roaming: :random },
    :BRUXISH => { behavior_noticed: :aggressive, behavior_roaming: :random , behavior_pokemon: {:SHELLDER => :aggressive, :MAREANIE => :aggressive, :TOXAPEX => :aggressive}},
    :DRAMPA => { behavior_noticed: nil,  behavior_roaming: :random },
    :DHELMISE => { behavior_noticed: :still, behavior_roaming: :look_around , behavior_pokemon: {:WAILMER => :semi_aggressive, :WAILORD => :aggressive, :SKRELP => :curious, :DRAGALGE => :curious}},
