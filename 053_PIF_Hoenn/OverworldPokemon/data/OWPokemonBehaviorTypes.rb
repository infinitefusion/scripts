...
POKEMON_BEHAVIOR_DATA =
  {
    ...
    :PIDGEOTTO => { behavior_noticed: nil,  behavior_roaming: :random, behavior_pokemon: {:MAGIKARP => :aggressive, :EXEGGCUTE => :aggressive} },
    :PIDGEOT => { behavior_noticed: nil,  behavior_roaming: :random,  behavior_pokemon: {:MAGIKARP => :aggressive, :EXEGGCUTE => :aggressive} },
    ...
    :SHELLDER => { behavior_noticed: :skittish, behavior_roaming: :look_around,  behavior_pokemon: {:KINGLER => :skittish, :KRABBY => :skittish} },
    ...
    :STARYU => { behavior_noticed: nil, behavior_roaming: :random, glow_in_the_dark: true },
    :STARMIE => { behavior_noticed: nil, behavior_roaming: :random, glow_in_the_dark: true },
    ...
    :CHINCHOU => { behavior_noticed: nil, behavior_roaming: :random, glow_in_the_dark: true },
    :LANTURN => { behavior_noticed: nil, behavior_roaming: :random, glow_in_the_dark: true },
    ...
    :SUNKERN => { behavior_noticed: nil, behavior_roaming: :random, behavior_sunny_roaming: :random_spin,  behavior_pokemon: {:SUNKERN => :random_spin}},
    ...
    :FINNEON => { behavior_noticed: :skittish, behavior_roaming: :random, glow_in_the_dark: true },
    :LUMINEON => { behavior_noticed: nil, behavior_roaming: :random, glow_in_the_dark: true },
    ...
    :DWEBBLE => { behavior_noticed: :skittish, behavior_roaming: :still },
    ...
    :SHIINOTIC => { behavior_noticed: nil, behavior_roaming: :random, glow_in_the_dark: true },
