...
QUEST_REWARDS = Settings::KANTO ? [
  ...
  QuestReward.new(10, :LINKINGCORD, 1, _INTL("This strange cable triggers the evolution of Pokémon that typically evolve via trade. I know you'll put it to good use!")),
  ...
  QuestReward.new(15, :LINKINGCORD, 3, _INTL("This handy item will allow you to sleep anywhere you want. You won't even need hotels anymore!")),
  QuestReward.new(20, :MISTSTONE, 1, _INTL("This rare stone can evolve any Pokémon, regardless of their level or evolution method. Use it wisely!"), true),
  QuestReward.new(25, :GSBALL, 1, _INTL("This mysterious ball is rumored to be the key to call upon the protector of Ilex Forest.  It's a precious relic.")),
  QuestReward.new(30, :MASTERBALL, 1, _INTL("This rare ball can catch any Pokémon. Don't waste it!"), true),
]
